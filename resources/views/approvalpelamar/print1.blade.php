					...
					<div class="yui-b" style="font-size:15px;">
						...
						<center>
							...
							<div class="row col-md-12">
								@if (!is_null($lempar['p_img_ktp']))
								<img src="{{ url($lempar['p_img_ktp']) }}" width="100%">
								@else
								<!-- <img src="{{ url('assets/img/img_not_found.png') }}" alt="Foto"> -->
								@endif
							</div>

							<div class="row col-md-12">
								@if (!is_null($lempar['p_img_skck']))
								<img src="{{ url($lempar['p_img_skck']) }}" width="100%">
								@else
								<!-- <img src="{{ url('assets/img/img_not_found.png') }}" alt="Foto"> -->
								@endif
							</div>
							...
							<div class="row col-md-12">
								@if (!is_null($lempar['p_img_ijazah']))
								<img src="{{ url($lempar['p_img_ijazah']) }}" width="100%">
								@else
								<!-- <img src="{{ url('assets/img/img_not_found.png') }}" alt="Foto"> -->
								@endif
							</div>
							...
							<div class="row col-md-12">
								@if (!is_null($lempar['p_img_medical']))
								<img src="{{ url($lempar['p_img_medical']) }}" width="100%">
								@else
								<!-- <img src="{{ url('assets/img/img_not_found.png') }}" alt="Foto"> -->
								@endif
							</div>
							...
							<div class="row col-md-12">
								@if (!is_null($lempar['p_img_kk']))
								<img src="{{ url($lempar['p_img_kk']) }}" width="100%">
								@else
								<!-- <img src="{{ url('assets/img/img_not_found.png') }}" alt="Foto"> -->
								@endif
							</div>
							...
							<div class="row col-md-12">
								@if (!is_null($lempar['p_img_rekening']))
								<img src="{{ url($lempar['p_img_rekening']) }}" width="100%">
								@else
								<!-- <img src="{{ url('assets/img/img_not_found.png') }}" alt="Foto"> -->
								@endif
							</div>
							...
							<div class="row col-md-12">
								@if (!is_null($lempar['p_img_bpjs']))
								<img src="{{ url($lempar['p_img_bpjs']) }}" width="100%">
								@else
								<!-- <img src="{{ url('assets/img/img_not_found.png') }}" alt="Foto"> -->
								@endif
							</div>
							...
							<div class="row col-md-12">
								@if (!is_null($lempar['p_img_rbh']))
								<img src="{{ url($lempar['p_img_rbh']) }}" width="100%">
								@else
								<!-- <img src="{{ url('assets/img/img_not_found.png') }}" alt="Foto"> -->
								@endif
							</div>
							...
							<div class="row col-md-12">
								@if (!is_null($lempar['p_img_rekpayroll']))
								<img src="{{ url($lempar['p_img_rekpayroll']) }}" width="100%">
								@else
								<!-- <img src="{{ url('assets/img/img_not_found.png') }}" alt="Foto"> -->
								@endif
							</div>
							...
							<div class="row col-md-12">
								@if (!is_null($lempar['p_img_pkwt']))
								<img src="{{ url($lempar['p_img_pkwt']) }}" width="100%">
								@else
								<!-- <img src="{{ url('assets/img/img_not_found.png') }}" alt="Foto"> -->
								@endif
							</div>
							...
							<div class="row col-md-12">
								@if (!is_null($lempar['p_img_sk']))
								<img src="{{ url($lempar['p_img_sk']) }}" width="100%">
								@else
								<img src="{{ url('assets/img/img_not_found.png') }}" alt="Foto">
								@endif
							</div>
